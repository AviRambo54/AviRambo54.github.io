...
<head>
  ...
  <title>${title}</title>
  <link rel="stylesheet" href="css/style.css?v=20260921a">
  <script type="module" src="js/site.js?v=20260921a"></script>
</head>
<body data-page="${page}">
  <a class="skip-link" href="#content">דילוג לתוכן</a>
  <header class="site-header">
    <a class="brand" href="index.html" aria-label="אבירם שגב — מעצב חוויה חזותית">
      <img class="brand-logo" data-brand="logo" alt="אבירם שגב — מעצב חוויה חזותית">
    </a>
